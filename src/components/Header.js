            ...
            <div className="nav-outer-wrapper">
                <h1 class="leading-none text-2xl text-grey-darkest">
                    <Link to="/" class="no-underline text-white font-bold hover:text-secondary">
                        <img className="w-12 h-12 md:w-16 md:h-16 rounded-full animate-spin-slow" src="/images/logo.jpeg" />
                    </Link>
                </h1>
                ...
                <nav className={`md:block ${isHidden ? "hidden" : "block"} `}>
                    <ul class={`list-reset md:flex md:items-center font-press-start ${isHidden ? "" : "nav-sm-screen"}`}>
                        <li class="md:ml-4 md:mx-8">
                            <Link to="/characters" class="nav-link">
                                Characters
                            </Link>
                        </li>
                        <li class="md:ml-4 md:mx-8">
